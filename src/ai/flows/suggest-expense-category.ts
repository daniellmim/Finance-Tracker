 ...
 *
 * - suggestExpenseCategory - A function that suggests an expense category for a given expense description.
...
const SuggestExpenseCategoryInputSchema = z.object({
  expenseDescription: z
    .string()
    .describe('A description of the expense for which a category is needed.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert personal finance assistant. Your task is to suggest a relevant expense category for a given expense description.

Expense Description: {{{expenseDescription}}}

Suggest a category for this expense:
`,
});
